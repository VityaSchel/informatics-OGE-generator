...
----------|----------|----------
 ...
 4        | Кратчайший путь между пунктами по дорогам | [⚠️ Генерация](https://github.com/VityaSchel/informatics-OGE-generator/issues/9)
 5        | Вычислить число по алгоритму | ✅
 6        | Сколько раз программа напечатала Х | ✅
 7        | Составление URL адреса до файла по частям | ✅
 8        | Поисковые запросы | ✅
 9        | Количество путей от точки до точки | [⚠️ Проверка](https://github.com/VityaSchel/informatics-OGE-generator/issues/8)
